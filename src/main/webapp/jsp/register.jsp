        		...
        		<center><form method="post" action="registration">
        			<fieldset>
        				...
        				<div>
        				 ...
        				 <input type="text" name="firstName" pattern="[A-Za-z]{2,20}" required>
        				 <br>
        				 <fmt:message key="registration.lastname" bundle="${locale}"/><br>
        				<input type="text" name="lastName" pattern="[A-Za-z]{2,30}" required>
        				<br>
        				...
        				<input type="text" name="login" pattern="[A-Za-z0-9]{4,20}" required>
        				<br>
